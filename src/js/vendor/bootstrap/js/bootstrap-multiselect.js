...
!function($) {
    ...
    Multiselect.prototype = {
        ...
        defaults: {
            ...
            buttonWidth: 'auto',
            buttonContainer: '<div class="col-sm-5 btn-group" style="padding: 0;"/>',
        ...
        templates: {
            button: '<button type="button" class="col-sm-12 multiselect dropdown-toggle" style="100%;" data-toggle="dropdown"></button>',
            ul: '<ul class="multiselect-container dropdown-menu" style="min-width: 10px;"></ul>',
